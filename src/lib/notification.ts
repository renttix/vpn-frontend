...
export function isPushNotificationSupported() {
  ...
  if (!NOTIFICATIONS_ENABLED || typeof window === 'undefined' || typeof navigator === 'undefined') {
    return false;
  }
...
function urlBase64ToUint8Array(base64String: string) {
  ...
  if (typeof window === 'undefined') {
    throw new Error('Cannot convert base64 to Uint8Array in a non-browser environment');
  }
