    ...
    <div className="border-t border-gray-200 dark:border-gray-800">
      <div className="container mx-auto py-10 px-4">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-3xl font-roboto font-bold text-vpn-gray dark:text-gray-100 mb-4" style={{ fontFamily: 'Roboto, sans-serif' }}>
            Got a tip or story worth investigating?
          </h2>
          <p className="text-lg text-vpn-gray dark:text-gray-300 mb-6">
