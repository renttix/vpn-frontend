...
export default function OrganizationJsonLd({ url = 'https://vpnnews.com' }: OrganizationJsonLdProps) {
  ...
  const jsonLd = {
    ...
    "description": "Video Production News (VPN) is a leading source for breaking legal news, court reports, expert analysis on criminal cases, legal developments, and in-depth coverage of high-profile trials.",
    ...
    "correctionsPolicy": {
      "@type": "CreativeWork",
      "url": "https://vpnnews.com/corrections-policy",
    ...
    "verificationFactCheckingPolicy": {
      "@type": "CreativeWork",
      "url": "https://vpnnews.com/fact-checking-policy",
    ...
    "unnamedSourcesPolicy": {
      "@type": "CreativeWork",
      "url": "https://vpnnews.com/unnamed-sources-policy",
    ...
    "ownershipFundingInfo": {
      "@type": "CreativeWork",
      "url": "https://vpnnews.com/ownership",
      "description": "Video Production News is independently owned by VPN Media Holdings Ltd. Our revenue comes from: digital subscriptions (60%), advertising (30%), and events and partnerships (10%). We maintain a strict separation between editorial and business operations to ensure journalistic integrity."
    },
    // News-specific properties
    "noBylinesPolicy": {
      "@type": "CreativeWork",
      "url": "https://vpnnews.com/bylines-policy",
