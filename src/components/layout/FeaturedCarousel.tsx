    ...
    >
      <div className="relative aspect-[1.9/1] h-auto">
        ...
        <div className="relative z-10 flex flex-col justify-end h-full pb-6 sm:pb-10 px-4 sm:px-6">
          ...
          <h2 className="font-roboto font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl max-w-3xl mb-2 sm:mb-4 leading-tight tracking-tight" style={{ fontFamily: 'Roboto, sans-serif' }}>
